...
fire_dragon = TournamentCard('dragon_001', "Fire Dragon", 5, 'Common', 1200, 10, 6)
ice_wizard = TournamentCard('wizard_001', "Ice Wizard", 4, 'Legendary', 1150, 2, 6)
...
print(f"Match result: {tournamentPlatform.create_match('dragon_001', 'wizard_001')}\n")
